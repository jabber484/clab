...
--
-- 主機: localhost
-- 建立日期: 2017 年 11 月 15 日 05:28
-- 伺服器版本: 5.5.55-0ubuntu0.14.04.1
-- PHP 版本: 5.6.30-12~ubuntu14.04.1+deb.sury.org+1
...
(1, 'Machine', 'RX-78-2 Gundam', 'Prototype Mobile Suit', NULL, NULL),
(2, 'Machine', 'RX-78GP02A Physalis', 'Prototype Nuclear Assault Mobile Suit', NULL, NULL),
(3, 'Machine', 'RX-78GP01 Zephyranthes', 'Prototype General-Purpose Mobile Suit', NULL, NULL),
(4, 'Machine', 'RX-0 Unicorn', 'Prototype Full Psycoframe Mobile Suit', NULL, NULL),
(5, 'Sharps', '60mm Vulcan Gun', 'Anti-Light Armor Weapon', NULL, NULL),
(6, 'Drills', 'Beam Saber', 'High-energy Minovsky particles blade', NULL, NULL);
