...
-- 資料庫： `clab`
--
CREATE DATABASE IF NOT EXISTS `clab` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `clab`;
...
INSERT INTO `logins` (`id`, `sid`, `password`, `created_at`, `updated_at`) VALUES
(1, 1155078921, '123456', NULL, NULL);
...
(9, '2017_09_04_085918_create_sessions_table', 1),
(10, '2017_09_06_090435_catalog', 1),
(11, '2017_09_20_023516_project', 1),
(12, '2017_11_14_034343_event_type', 1),
(13, '2017_11_15_071742_catalog_type', 1),
...
(20, '2017_11_17_114108_create_users_table', 5),
(21, '2017_11_17_114549_create_logins_table', 5),
(22, '2017_11_17_120042_create_privileges_table', 5),
(23, '2017_11_17_120158_create_privilege_rights_table', 5);
...
--
-- 資料表結構 `privilege_rights`
--

CREATE TABLE `privilege_rights` (
  `id` int(10) UNSIGNED NOT NULL,
  `right` int(11) NOT NULL,
...
INSERT INTO `projects` (`id`, `type`, `name`, `short_des`, `description`, `picture`, `thumbnail`, `isIdea`, `fromDate`, `toDate`, `sid`, `alias`, `contact`, `created_at`, `updated_at`) VALUES
...
(11, 4, '4', '<p>ghjghjghj</p>', '<p>ghjghjghjghj</p>', 'storage/project/large/e9b396aeb36582d279682edebdfb1116.jpg', 'storage/project/thumbnail/e9b396aeb36582d279682edebdfb1116.jpg', 0, '2016-01-01', '2016-01-01', '', 'sdf', 'dsfsdf', '2017-11-16 10:34:44', '2017-11-16 10:34:44');
...
ALTER TABLE `catalogs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `catalogs_id_unique` (`id`);
...
ALTER TABLE `catalog_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `catalog_types_id_unique` (`id`);
...
ALTER TABLE `event_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `event_types_id_unique` (`id`);
...
--
-- 資料表索引 `privilege_rights`
--
ALTER TABLE `privilege_rights`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用資料表 AUTO_INCREMENT `catalogs`
--
ALTER TABLE `catalogs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用資料表 AUTO_INCREMENT `catalog_types`
--
ALTER TABLE `catalog_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用資料表 AUTO_INCREMENT `event_types`
--
ALTER TABLE `event_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `migrations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用資料表 AUTO_INCREMENT `privileges`
--
ALTER TABLE `privileges`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用資料表 AUTO_INCREMENT `privilege_rights`
--
ALTER TABLE `privilege_rights`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
